...
import com.android.locationtracker.databinding.ActivityDirectionfindBinding;
...
public class Directionfind extends AppCompatActivity implements OnMapReadyCallback {


    private GoogleMap mMap;
    private ActivityDirectionfindBinding binding;
    ...
    private View getDirectionBtn;
    private View swapButton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding= ActivityDirectionfindBinding.inflate(getLayoutInflater());
